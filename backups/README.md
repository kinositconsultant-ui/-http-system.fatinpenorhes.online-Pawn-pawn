...
Snapshot taken: **20260804-1402 UTC**

## Files in this folder

| File | Purpose |
|---|---|
| `mongodb-backup-20260804-1402.zip` | Full `mongodump` of the `test_database` database |
| `uploads-backup-20260804-1402.zip` | All client documents & item photos (with `MANIFEST.json`) |
...
```bash
# 1. MongoDB
unzip mongodb-backup-20260804-1402.zip -d ./
mongorestore --uri="mongodb://localhost:27017" --db=test_database ./mongodump-20260804-1402/test_database
